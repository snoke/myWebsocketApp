        ...
        <b-collapse id="accordion-1" visible accordion="my-accordion" role="tabpanel">
          <b-card-body>
            <div id="auth_login">
              ...
              <button v-on:click="login()" class="btn btn-outline-primary  w-100">login
        ...
        <b-collapse id="accordion-2" accordion="my-accordion" role="tabpanel">
          <b-card-body>
            <div id="auth_register">
              <div class="w-100">
                <div class="alert row alert-danger" v-if="register_message && register_message.status===1">
              ...
              <input type="password" placeholder="repeat Password" name="password" v-model="register_password2"
                     class="w-100"/>
              <button v-on:click="register()" class="btn btn-outline-primary w-100">register
